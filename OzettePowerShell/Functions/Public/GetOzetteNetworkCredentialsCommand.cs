...
namespace OzettePowerShell.Functions.Public
{
    ...
    ///   <para type="description">Note: Only the friendly name/description of the credential will be returned. The encrypted username and password values are not returned in this cmdlet.</para>
